...
export const phoneNumber = value => {
  if (value && !isMobilePhone(value, 'any')) return 'Invalid phone number';
};
...
export const repeatPassword = (value, allValues) => {
  if (!(allValues.password === allValues.reEnterPassword)) {
    return "Passwords Don't Match";
  }
};

export const repeatBankAccountNumber = (value, allValues) => {
  if (!(allValues.bankAccountNumber === allValues.confirmAccountNumber)) {
